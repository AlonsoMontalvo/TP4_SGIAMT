...
var getlistusuarios = function (flag) {
    ...
    $.ajax({
        url: "/TProgresoes/GetUsersPagination",
        type: "GET",
        ...
        colModel: [
            ...
            { label: 'Tipo de Nivel', name: 'tnivel' },
            {
                label: 'Opciones', name: 'Opciones', formatter: function (cellvalue, options, rowObject) {
                    var norma = '<button onclick="crear(' + options.rowId + ')", <a href="#" class="btn btn-primary btn-default"><span class="glyphicon glyphicon-circle-arrow-right"></span> Gestionar</a></button>';
                    return norma;
                }
            }
        ],
...
var crear = function (iddni) {
    window.location.href = url.CreateProgreso + '?iddni=' + iddni;
};
