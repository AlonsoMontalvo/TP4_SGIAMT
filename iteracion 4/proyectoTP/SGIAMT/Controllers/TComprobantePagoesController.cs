...
namespace SGIAMT_Integracion.Controllers
{
    public class TComprobantePagoesController : Controller
    {
        ...
        public TComprobantePagoesController(BD_SGIAMTIntegracionfinalContext context)
        {
            _context = context;
        }
        ...
        //{
        //    var usuario = from m in _context.TComprobantePago
        //                  join v in _context.TPago on m.PkIcpId equals v.FkIcpId
        //                  join ntp in _context.TUsuario on v.FkIuDni equals ntp.PkIuDni
        //                  where ntp.VuEstado == "Inactivo" where v.PkIpId==id
        //                  select m;
        //                      TempData["PkIpId"] = usuario;
