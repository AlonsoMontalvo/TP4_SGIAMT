...
namespace SGIAMT_Integracion.Controllers
{
    public class TUsuarioxProgresoesController : Controller
    {
        ...
        public TUsuarioxProgresoesController(BD_SGIAMTIntegracionContext context)
        {
            _context = context;
        }
        ...
        {
            var bD_SGIAMTIntegracionContext = _context.TUsuarioxProgreso.Include(t => t.FkIpCodNavigation).Include(t => t.FkIuDniNavigation);
        ...
        public IActionResult Create()
        {
            var usuario = from u in _context.TUsuario
                          where u.FkItuTipoUsuario == 1 && u.VuEstado == "Activo"
                          select u;
        ...
        {
            bool Isdniexist = _context.TUsuarioxProgreso.Any
                  (x => x.PkIuxPCod == tUsuarioxProgreso.PkIuxPCod);
            if (Isdniexist == true)
            {
        ...
        // GET: TUsuarioxProgresoes/Delete/5
        ...
        //// POST: TUsuarioxProgresoes/Delete/5
        //[HttpPost, ActionName("Delete")]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> DeleteConfirmed(int id)
        //{
        //    var tUsuarioxProgreso = await _context.TUsuarioxProgreso.FindAsync(id);
        //    _context.TUsuarioxProgreso.Remove(tUsuarioxProgreso);
        //    await _context.SaveChangesAsync();
        //    return RedirectToAction(nameof(Index));
        //}
        [HttpDelete]
