...
namespace CUS_Administrar_Asistencia.Controllers
{
    public class TAsistenciasController : Controller
    {
        private readonly BD_Administrar_AsistenciaContext _context;

        public TAsistenciasController(BD_Administrar_AsistenciaContext context)
        {
            _context = context;
        }
