...
{
    public partial class BD_SGIAMTIntegracionContext : DbContext
    {
        public BD_SGIAMTIntegracionContext()
        {
        }

        public BD_SGIAMTIntegracionContext(DbContextOptions<BD_SGIAMTIntegracionContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-88BB4F1\\SQLEXPRESS;Database=BD_SGIAMTIntegracion;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TComprobantePago>(entity =>
            {
                ...
                entity.Property(e => e.VcpDcumento).HasColumnName("VCP_Dcumento");
                ...
                entity.HasOne(d => d.FkIp)
                    ...
                    .HasConstraintName("FK__T_Comprob__FK_IP__48CFD27E");
            });
